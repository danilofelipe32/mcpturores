...
export const ICONS = {
    ...
    FLASHCARD: <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2H5a2 2 0 00-2 2v2m14 0h-2" /></svg>,
    SELF_REFLECTION: <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9 19c-3.314 0-6-2.686-6-6s2.686-6 6-6 6 2.686 6 6-2.686 6-6 6zm0 0c-1.392 0-2.714-.47-3.771-1.29M9 4.5A2.5 2.5 0 0111.5 7M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path d="M11.5 7a4.49 4.49 0 012.062 8.5" /><path d="M13 14c.002.333.002.667.002 1a2.5 2.5 0 01-5 0c0-.333 0-.667.002-1" /><path d="M12.5 10.5c0 .333.333.5.5.5s.5-.167.5-.5c0-.5-.5-1-1.5-1s-1.5.5-1.5 1c0 .333.167.5.5.5s.5-.167.5-.5" /></svg>,
    CHAIN_OF_THOUGHT: <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M8.5 11.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM15.5 11.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" /><path strokeLinecap="round" strokeLinejoin="round" d="M10 11.5h4" /></svg>,
    TREE_OF_THOUGHTS: <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 3v7m0 0-3-3m3 3 3-3m-3 7v7m0 0-3-3m3 3 3-3" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 10a2 2 0 100-4 2 2 0 000 4zM9 17a2 2 0 100-4 2 2 0 000 4zM15 17a2 2 0 100-4 2 2 0 000 4z" /></svg>,
};
